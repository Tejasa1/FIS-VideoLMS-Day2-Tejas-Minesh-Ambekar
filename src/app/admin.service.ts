...
export class AdminService {
  ...
  searchByRating(rating:number){
    return this.httpClient.get("http://localhost:8082/customers/search/rating/"+rating)
  }

  searchByLead(Lead:string){
    return this.httpClient.get("http://localhost:8081/admins/search/actor/"+Lead)
  }
